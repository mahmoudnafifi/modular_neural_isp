...
This project follows a beta release cycle.
...
## v0.1.3 (Beta) — 2025-12-29
- Fixed Apple ProRAW CCT/Tint validation to avoid false out-of-range errors.

> Source update only. No executables were released for this version.
...
## v0.1.1 (Beta) — 2025-12-29
- Support for PNG images with alpha channels.
- Python fallback for metadata extraction when ExifTool is unavailable.
